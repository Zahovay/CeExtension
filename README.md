...
Cold Embrace extension for ConsumesManager on Turtle WoW. It adds CE-specific presets and role/spec handling to help your raid track required consumables.
